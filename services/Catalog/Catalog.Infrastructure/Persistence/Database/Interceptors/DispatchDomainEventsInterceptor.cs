...
namespace Catalog.Infrastructure.Persistence.Database.Interceptors;
...
/// commits. Handlers resolve from the same DI scope as the DbContext, so projection +
/// outbox publishers enrolled as handlers write in the same transaction as the aggregate
/// save (CQRS-projection-on-Postgres atomic write per <c>catalog.md § 9</c>).
/// </summary>
