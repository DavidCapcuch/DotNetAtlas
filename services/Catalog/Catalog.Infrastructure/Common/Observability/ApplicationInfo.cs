...
namespace Catalog.Infrastructure.Common.Observability;

/// <summary>
/// Application metadata for Catalog BC instrumentation.
/// </summary>
public static class ApplicationInfo
{
    /// <summary>
    /// Application name used for telemetry identification. Matches the
    /// docker-compose <c>OTEL_SERVICE_NAME=Catalog</c> override and the natural
    /// BC name; consistent across appsettings, code, and runtime env.
    /// </summary>
    public const string AppName = "Catalog";
