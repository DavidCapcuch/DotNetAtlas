...
/// <see cref="Scopes.CatalogWrite"/> (write implies read); the write policy requires
/// <see cref="Scopes.CatalogWrite"/>. Both are enforced inside
...
internal static class AuthPolicies
{
    ...
    /// <summary>Gates Catalog admin command endpoints — requires <c>catalog.write</c>.</summary>
