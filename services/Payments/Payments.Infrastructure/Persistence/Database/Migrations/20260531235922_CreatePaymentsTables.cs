...
{
    /// <inheritdoc />
    public partial class CreatePaymentsTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    void_reason = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true, comment: "Saga-supplied reason for the void (H-5 closeout; nullable until Void succeeds)."),
            ...
            migrationBuilder.CreateIndex(
                name: "ix_payment_transactions_buyer_id",
                schema: "payments",
