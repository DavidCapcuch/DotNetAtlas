...
/// </summary>
/// <remarks>
/// Internal helper composed by
/// <c>Payments.Infrastructure/Common/InfrastructureDependencyInjection.cs</c> and
/// <c>Payments.Api/Program.cs</c> into the application's DI graph alongside DbContext,
/// Kafka consumers, and outbox-relay configuration.
/// </remarks>
internal static class PaymentGatewayDependencyInjection
{
    ...
    /// will replace this — wrapping <see cref="System.Net.Http.HttpClient"/> or a gateway
    /// SDK — is also intended to be a singleton, so the lifetime contract is
    /// forward-compatible.
    /// </summary>
