...
/// <para>
/// The consumer group id (the idempotent rebalance key) carries no annotation and no validator:
/// <c>AddKafka</c> builds the cluster during DI registration, and <c>ConsumerConfiguration</c>'s
/// constructor rejects a null or empty <c>GroupId</c> there — strictly before options validation,
/// which only runs once the host starts.
/// </para>
/// <para>
