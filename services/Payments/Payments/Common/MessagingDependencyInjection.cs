...
using Payments.Transactions.AuthorizePayment;
using Payments.Transactions.CapturePayment;
using Payments.Transactions.RequestRefund;
using Payments.Transactions.VoidPayment;
            ...
            .AddCluster(cluster => cluster
                ...
                .AddConsumer(consumer => consumer
                    ...
                    .AddMiddlewares(middlewares => middlewares
                        ...
                        .AddInbox(typeof(CapturePaymentCommand), typeof(AuthorizePaymentCommand),
                            typeof(VoidPaymentCommand), typeof(RequestRefundCommand))
