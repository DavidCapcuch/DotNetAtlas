...
/// Configures distributed tracing/metrics (OpenTelemetry) for the Basket BC.
/// </summary>
public static class ObservabilityDependencyInjection
{
    /// <summary>
    /// Configures OpenTelemetry distributed tracing and metrics.
    /// Sets up instrumentation for ASP.NET Core, HTTP clients, EF Core (the SQL
    /// outbox side-car), Redis (the primary basket store on
    /// <c>redis-basket</c>), and FusionCache.
    /// </summary>
