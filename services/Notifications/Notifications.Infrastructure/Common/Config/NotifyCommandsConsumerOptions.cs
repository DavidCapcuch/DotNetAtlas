...
/// </para>
/// <para>
/// The consumer group id carries no annotation and no validator: <c>AddKafka</c> builds the cluster
/// during DI registration, and <c>ConsumerConfiguration</c>'s constructor rejects a null or empty
