...
namespace Notifications.Infrastructure.Persistence.Database.Migrations
{
    ...
    [Migration("20260609163502_AddUserPreferences")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Notifications.Domain.Preferences.NotificationPreference", b =>
                {
                    ...
                    b.ToTable("user_preferences", "notifications", t =>
                        {
                            t.HasComment("Seeded recipient preference + contact reference, keyed user_id (Keycloak sub). notifications.md §8.");
                        });
                });
