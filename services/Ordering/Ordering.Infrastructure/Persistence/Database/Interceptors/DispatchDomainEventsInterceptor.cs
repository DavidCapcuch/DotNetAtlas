...
/// <see cref="DbContext.SaveChangesAsync(CancellationToken)" /> commits. Handlers resolve from the
/// same DI scope as the DbContext, so outbox publishers enrolled as handlers
/// write in the same transaction as the aggregate save (reliable messaging
/// guarantee).
/// </summary>
