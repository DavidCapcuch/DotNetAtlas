...
BEGIN
    ...
    COMMENT ON COLUMN ordering.outbox_messages.type IS 'Avro type name of the serialized event (e.g., ''OrderConfirmedEvent'') for deserialization and observability';
