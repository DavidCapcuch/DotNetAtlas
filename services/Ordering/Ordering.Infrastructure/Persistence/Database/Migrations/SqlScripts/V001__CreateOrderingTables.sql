...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM ordering."__EFMigrationsHistory" WHERE "migration_id" = '20260604194427_CreateOrderingTables') THEN
        IF NOT EXISTS(SELECT 1 FROM pg_namespace WHERE nspname = 'ordering') THEN
            CREATE SCHEMA ordering;
        END IF;
    END IF;
...
BEGIN
    ...
    VALUES ('20260604194427_CreateOrderingTables', '10.0.8');
    END IF;
END $EF$;
