...
/// consumer). Kafka reports <see cref="HealthStatus.Degraded"/> and the rest
...
internal static class HealthChecksDependencyInjection
{
        ...
        ConfigurationManager configuration)
    {
        ...
        services.AddHealthChecks()
            ...
            // Degraded per ServiceDefaultHealthCheckTags.ReadinessTag: no Ordering request path
            // publishes — business events go through the outbox and outbox-relay-ordering. The two
