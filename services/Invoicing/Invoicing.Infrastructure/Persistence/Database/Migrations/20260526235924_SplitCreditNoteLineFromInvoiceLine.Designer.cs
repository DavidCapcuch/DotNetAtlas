...
namespace Invoicing.Infrastructure.Persistence.Database.Migrations
{
    ...
    [Migration("20260526235924_SplitCreditNoteLineFromInvoiceLine")]
    partial class SplitCreditNoteLineFromInvoiceLine
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Invoicing.Domain.CreditNotes.CreditNote", b =>
                {
                    ...
                    b.HasIndex("BuyerId")
                        .HasDatabaseName("IX_CreditNotes_BuyerId");
            ...
            modelBuilder.Entity("Invoicing.Domain.Invoices.Invoice", b =>
                {
                    ...
                    b.HasIndex("BuyerId")
                        .HasDatabaseName("IX_Invoices_BuyerId");
            ...
            modelBuilder.Entity("Platform.ReliableMessaging.Outbox.Core.OutboxMessage", b =>
                {
                    ...
                    b.ToTable("OutboxMessages", "invoicing", t =>
                        {
