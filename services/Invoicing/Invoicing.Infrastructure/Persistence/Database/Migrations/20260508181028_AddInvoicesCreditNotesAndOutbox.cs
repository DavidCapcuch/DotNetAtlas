...
{
    /// <inheritdoc />
    public partial class AddInvoicesCreditNotesAndOutbox : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    correlation_id = table.Column<Guid>(type: "uuid", nullable: false, comment: "Cancellation flow correlation id; used as M7 idempotency key."),
                    ...
                    pdf_blob_uri = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: true, comment: "Presigned SAS URL to the rendered credit-note PDF."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    total_amount = table.Column<decimal>(type: "numeric(19,4)", precision: 19, scale: 4, nullable: false),
                    total_currency = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: false),
                    pdf_blob_uri = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: true, comment: "Presigned SAS URL to the rendered PDF in blob storage."),
                    pdf_content_hash = table.Column<string>(type: "character(64)", fixedLength: true, maxLength: 64, nullable: true, comment: "SHA-256 of the PDF bytes, lowercase hex (64 chars)."),
                    pdf_size_bytes = table.Column<long>(type: "bigint", nullable: true, comment: "PDF size in bytes (>0)."),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CreditNotes_BuyerId",
                schema: "invoicing",
                table: "credit_notes",
                column: "buyer_id");

            migrationBuilder.CreateIndex(
                name: "UX_CreditNotes_CorrelationId",
                schema: "invoicing",
                table: "credit_notes",
            ...
            migrationBuilder.CreateIndex(
                name: "UX_CreditNotes_CreditNoteNumber",
                schema: "invoicing",
                table: "credit_notes",
            ...
            migrationBuilder.CreateIndex(
                name: "UX_CreditNotes_OriginalInvoiceId",
                schema: "invoicing",
                table: "credit_notes",
            ...
            migrationBuilder.CreateIndex(
                name: "UX_Invoices_CorrelationId",
                schema: "invoicing",
                table: "invoices",
                column: "correlation_id",
                unique: true);
