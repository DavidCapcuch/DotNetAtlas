...
namespace Invoicing.Infrastructure.Persistence.Database.Migrations
{
    ...
    [Migration("20260508181028_AddInvoicesCreditNotesAndOutbox")]
    partial class AddInvoicesCreditNotesAndOutbox
    {
        /// <inheritdoc />
                    ...
                    b.OwnsMany("Invoicing.Domain.Common.ValueObjects.InvoiceLine", "Lines", b1 =>
                        {
                            ...
                            b1.ToTable("credit_note_lines", "invoicing", t =>
                                {
                                    t.HasComment("CreditNote line items — sign-flipped copy of the original Invoice's lines.");
                                });
                            ...
                            b1.OwnsOne("Platform.SharedKernel.ValueObjects.Money", "LineTotal", b2 =>
                                {
                                    b2.Property<Guid>("InvoiceLineCreditNoteId")
                                        .HasColumnType("uuid")
                                        .HasColumnName("credit_note_id");
                                    ...
                                    b2.HasKey("InvoiceLineCreditNoteId", "InvoiceLineLineNumber");

                                    b2.ToTable("credit_note_lines", "invoicing");

                                    b2.WithOwner()
                                        .HasForeignKey("InvoiceLineCreditNoteId", "InvoiceLineLineNumber")
