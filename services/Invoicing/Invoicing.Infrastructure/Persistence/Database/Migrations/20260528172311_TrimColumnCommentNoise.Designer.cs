...
namespace Invoicing.Infrastructure.Persistence.Database.Migrations
{
    ...
    [Migration("20260528172311_TrimColumnCommentNoise")]
            ...
            modelBuilder.Entity("Invoicing.Application.CreditNotes.Projections.PendingCreditNote", b =>
                {
                    ...
                    b.ToTable("pending_credit_notes", "invoicing", t =>
                        {
                            t.HasComment("Async-enrichment buffer: collects OrderCancelledEvent + PaymentRefundedEvent halves keyed on CorrelationId until IssueCreditNoteCommandHandler converts the converged row into a CreditNote aggregate.");
                        });
                });
            ...
            modelBuilder.Entity("Invoicing.Application.Invoices.Projections.PendingInvoice", b =>
                {
                    ...
                    b.ToTable("pending_invoices", "invoicing", t =>
                        {
                            t.HasComment("Async-enrichment buffer: collects OrderConfirmedEvent + PaymentCapturedEvent halves keyed on CorrelationId until IssueInvoiceCommandHandler converts the converged row into an Invoice aggregate.");
                        });
                });
