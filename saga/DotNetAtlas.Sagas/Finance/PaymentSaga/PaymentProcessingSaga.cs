...
using DotNetAtlas.Sagas.Finance.PaymentSaga.Observability.Activities;
...
public sealed class PaymentProcessingSaga : MassTransitStateMachine<PaymentSagaState>
{
    ...
    // Events
    public Event<PaymentInitiatedSagaEvent> PaymentInitiated { get; private set; }
    public Event<PaymentAuthorizedSagaEvent> PaymentAuthorized { get; private set; }
    public Event<PaymentAuthorizationFailedSagaEvent> PaymentAuthorizationFailed { get; private set; }
    public Event<PaymentCapturedSagaEvent> PaymentCaptured { get; private set; }
    public Event<PaymentCaptureFailedSagaEvent> PaymentCaptureFailed { get; private set; }
    public Event<PaymentVoidedSagaEvent> PaymentVoided { get; private set; }
    public Event<PaymentRefundCompletedSagaEvent> RefundCompleted_ { get; private set; }
    public Event<RequestPaymentRefundCommand> RefundRequested { get; private set; }

    // Schedules
    public Schedule<PaymentSagaState, AuthorizationTimeoutExpired> AuthorizationTimeout { get; private set; }
    public Schedule<PaymentSagaState, CaptureTimeoutExpired> CaptureTimeout { get; private set; }
    public Schedule<PaymentSagaState, VoidTimeoutExpired> VoidTimeout { get; private set; }
    public Schedule<PaymentSagaState, RefundTimeoutExpired> RefundTimeout { get; private set; }
    ...
    private void ConfigureAwaitingCaptureState()
    {
        During(AwaitingCapture,
            When(PaymentCaptured)
                ...
                .PublishAsync(ctx => ctx.Init<global::Finance.Payments.PaymentCompletedEvent>(
                    new global::Finance.Payments.PaymentCompletedEvent
                    {
                        CorrelationId = ctx.Saga.CorrelationId,
                        UserId = ctx.Saga.UserId,
            ...
            When(PaymentCaptureFailed)
                ...
                .IfElse(ctx => ctx.Message.IsRetryable && ctx.Saga.CaptureRetryCount < _sagaOptions.MaxRetryAttempts,
                    ...
                    noRetry => noRetry
                        ...
                        .PublishAsync(ctx => ctx.Init<global::Finance.Payments.PaymentFailedEvent>(
                            new global::Finance.Payments.PaymentFailedEvent
                            {
                                CorrelationId = ctx.Saga.CorrelationId,
                                UserId = ctx.Saga.UserId,
    ...
    private void InitializeSagaState(BehaviorContext<PaymentSagaState, PaymentInitiatedSagaEvent> ctx)
    {
    ...
    private void HandleAuthorizationCompleted(
        BehaviorContext<PaymentSagaState, PaymentAuthorizedSagaEvent> ctx)
    {
    ...
    private void HandleAuthorizationFailed(
        BehaviorContext<PaymentSagaState, PaymentAuthorizationFailedSagaEvent> ctx)
    {
    ...
    private void HandleCaptureCompleted(
        BehaviorContext<PaymentSagaState, PaymentCapturedSagaEvent> ctx)
    {
    ...
    private void HandleCaptureFailed(
        BehaviorContext<PaymentSagaState, PaymentCaptureFailedSagaEvent> ctx)
    {
        ctx.Saga.ErrorCode = ctx.Message.ErrorCode;
        ctx.Saga.ErrorMessage = ctx.Message.ErrorMessage;
        ctx.Saga.LastUpdatedAtUtc = _timeProvider.GetUtcNow().UtcDateTime;
    ...
    private void HandleVoidCompleted(
        BehaviorContext<PaymentSagaState, PaymentVoidedSagaEvent> ctx)
    {
    ...
    private void HandleRefundCompleted(
        BehaviorContext<PaymentSagaState, PaymentRefundCompletedSagaEvent> ctx)
    {
