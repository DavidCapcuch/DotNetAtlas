...
/// </summary>
public sealed class SagaStartedActivity : IStateMachineActivity<SubscriptionExtensionSagaState, SubscriptionExtensionInitiatedEvent>
{
    ...
    public async Task Execute(
        BehaviorContext<SubscriptionExtensionSagaState, SubscriptionExtensionInitiatedEvent> context,
        IBehavior<SubscriptionExtensionSagaState, SubscriptionExtensionInitiatedEvent> next)
    {
    ...
    public Task Faulted<TException>(
        BehaviorExceptionContext<SubscriptionExtensionSagaState, SubscriptionExtensionInitiatedEvent, TException> context,
        IBehavior<SubscriptionExtensionSagaState, SubscriptionExtensionInitiatedEvent> next)
