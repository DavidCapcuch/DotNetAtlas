...
/// </summary>
public sealed class CaptureFailedActivity : IStateMachineActivity<PaymentSagaState, PaymentCaptureFailedEvent>
{
    ...
    public async Task Execute(
        BehaviorContext<PaymentSagaState, PaymentCaptureFailedEvent> context,
        IBehavior<PaymentSagaState, PaymentCaptureFailedEvent> next)
    {
        var saga = context.Saga;
        var message = context.Message;

        using var activity = PaymentSagaInstrumentation.StartActivity(nameof(CaptureFailedActivity), saga.CorrelationId);
    ...
    public Task Faulted<TException>(
        BehaviorExceptionContext<PaymentSagaState, PaymentCaptureFailedEvent, TException> context,
        IBehavior<PaymentSagaState, PaymentCaptureFailedEvent> next)
