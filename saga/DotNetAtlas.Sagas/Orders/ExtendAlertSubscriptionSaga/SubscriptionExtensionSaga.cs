...
using DotNetAtlas.Sagas.Orders.ExtendAlertSubscriptionSaga.Observability.Activities;
...
public sealed class SubscriptionExtensionSaga : MassTransitStateMachine<SubscriptionExtensionSagaState>
{
    ...
    public Event<SubscriptionExtensionInitiatedSagaEvent> SubscriptionExtensionInitiated { get; private set; }
    public Event<SubscriptionExtensionPaymentCompletedSagaEvent> PaymentCompleted { get; private set; }
    public Event<SubscriptionExtensionPaymentFailedSagaEvent> PaymentFailed_ { get; private set; }
    public Event<SubscriptionExtendedSagaEvent> SubscriptionExtended { get; private set; }
    public Event<SubscriptionExtensionFailedSagaEvent> SubscriptionExtensionFailed { get; private set; }
    public Event<ExtensionCompensationCompletedSagaEvent> CompensationCompletedEvent { get; private set; }

    public Schedule<SubscriptionExtensionSagaState, PaymentTimeoutExpired> PaymentTimeout { get; private set; }
    public Schedule<SubscriptionExtensionSagaState, ExtensionTimeoutExpired> ExtensionTimeout { get; private set; }
    public Schedule<SubscriptionExtensionSagaState, CompensationTimeoutExpired> CompensationTimeout { get; private set; }
    ...
    private void ConfigureInitialState()
    {
        Initially(
            When(SubscriptionExtensionInitiated)
                ...
                .PublishAsync(ctx => ctx.Init<global::Finance.Payments.PaymentRequestedEvent>(
                    new global::Finance.Payments.PaymentRequestedEvent
                    {
            ...
            When(SubscriptionExtensionFailed)
                ...
                .IfElse(ctx => ctx.Message.ShouldCompensate,
                    compensate => compensate
                        ...
                        .PublishAsync(ctx => ctx.Init<global::Finance.Payments.RequestRefundCommand>(
                            new global::Finance.Payments.RequestRefundCommand
                            {
                                CorrelationId = ctx.Saga.CorrelationId,
                                UserId = ctx.Saga.UserId,
                                PaymentTransactionId = ctx.Saga.PaymentTransactionId!.Value,
    ...
    private void InitializeSagaState(
        BehaviorContext<SubscriptionExtensionSagaState, SubscriptionExtensionInitiatedSagaEvent> ctx)
    {
    ...
    private void HandleExtensionCompleted(
        BehaviorContext<SubscriptionExtensionSagaState, SubscriptionExtendedSagaEvent> ctx)
    {
    ...
    private void HandleExtensionFailed(
        BehaviorContext<SubscriptionExtensionSagaState, SubscriptionExtensionFailedSagaEvent> ctx)
    {
    ...
    private void HandlePaymentCompleted(
        BehaviorContext<SubscriptionExtensionSagaState, SubscriptionExtensionPaymentCompletedSagaEvent> ctx)
    {
    ...
    private void HandlePaymentFailed(
        BehaviorContext<SubscriptionExtensionSagaState, SubscriptionExtensionPaymentFailedSagaEvent> ctx)
    {
        ctx.Saga.ErrorCode = ctx.Message.ErrorCode;
        ctx.Saga.ErrorMessage = ctx.Message.ErrorMessage;
        ctx.Saga.LastUpdatedAtUtc = _timeProvider.GetUtcNow().UtcDateTime;
    ...
    private void HandleCompensationCompleted(
        BehaviorContext<SubscriptionExtensionSagaState, ExtensionCompensationCompletedSagaEvent> ctx)
    {
