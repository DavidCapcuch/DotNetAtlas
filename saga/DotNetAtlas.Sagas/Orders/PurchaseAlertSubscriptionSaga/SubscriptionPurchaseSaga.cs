...
using DotNetAtlas.Sagas.Orders.PurchaseAlertSubscriptionSaga.Observability.Activities;
...
public sealed class SubscriptionPurchaseSaga : MassTransitStateMachine<SubscriptionPurchaseSagaState>
{
    ...
    /// </summary>
    public Event<SubscriptionPurchasePaymentCompletedEvent> PaymentCompleted { get; private set; } = null!;

    /// <summary>
    /// Event triggered when payment fails.
    /// </summary>
    public Event<SubscriptionPurchasePaymentFailedEvent> PaymentFailed_ { get; private set; } = null!;
    ...
    /// </summary>
    public Event<SubscriptionPurchaseCompensationCompletedEvent> CompensationCompletedEvent { get; private set; } = null!;
    ...
    private void HandlePaymentCompleted(
        BehaviorContext<SubscriptionPurchaseSagaState, SubscriptionPurchasePaymentCompletedEvent> ctx)
    {
    ...
    private void HandlePaymentFailed(
        BehaviorContext<SubscriptionPurchaseSagaState, SubscriptionPurchasePaymentFailedEvent> ctx)
    {
        ctx.Saga.ErrorCode = ctx.Message.ErrorCode;
        ctx.Saga.ErrorMessage = ctx.Message.ErrorMessage;
        ctx.Saga.LastUpdatedAtUtc = _timeProvider.GetUtcNow().UtcDateTime;
    ...
    private void HandleCompensationCompleted(
        BehaviorContext<SubscriptionPurchaseSagaState, SubscriptionPurchaseCompensationCompletedEvent> ctx)
    {
