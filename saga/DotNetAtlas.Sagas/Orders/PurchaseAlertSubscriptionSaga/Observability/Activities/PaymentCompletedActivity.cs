...
/// </summary>
public sealed class
    PaymentCompletedActivity : IStateMachineActivity<SubscriptionPurchaseSagaState, SubscriptionPurchasePaymentCompletedEvent>
{
    ...
    public async Task Execute(
        BehaviorContext<SubscriptionPurchaseSagaState, SubscriptionPurchasePaymentCompletedEvent> context,
        IBehavior<SubscriptionPurchaseSagaState, SubscriptionPurchasePaymentCompletedEvent> next)
    {
    ...
    public Task Faulted<TException>(
        BehaviorExceptionContext<SubscriptionPurchaseSagaState, SubscriptionPurchasePaymentCompletedEvent, TException> context,
        IBehavior<SubscriptionPurchaseSagaState, SubscriptionPurchasePaymentCompletedEvent> next)
