...
/// <summary>
/// MassTransit state observer for logging <see cref="AlertSubscriptionPurchaseSaga"/> state transitions.
/// </summary>
/// <remarks>
    ...
    : IStateObserver<AlertSubscriptionPurchaseSagaState>
{
        ...
        State? previousState)
    {
        ...
        logger.LogInformation(
            "{SagaType} {CorrelationId} state changed: {PreviousState} -> {CurrentState} (User: {UserId}, Tier: {SubscriptionTier})",
            nameof(AlertSubscriptionPurchaseSaga), saga.CorrelationId, previousState?.Name ?? "None",
