...
/// <summary>
/// Asserts <see cref="BasketCheckoutInitiatedConsumer"/> forwards Basket's pre-assigned
/// <c>OrderId</c> (the saga key, ADR-0029) onto the initiator record, serialises items +
