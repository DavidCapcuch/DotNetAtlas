...
/// Correlated by <see cref="OrderId"/> — the saga key per ADR-0029. Consumed (one per distinct
/// ProductId) in <c>AwaitingStockReservation</c>; the saga stays in state until
/// <c>PendingReservations</c> reaches zero, then transitions to <c>AwaitingPayment</c> per § 4
/// transition table.
/// </summary>
