...
namespace SagaOrchestrators.Orders.AlertSubscriptionPurchaseSaga.Observability;

/// <summary>
/// Activity tags specific to the <see cref="AlertSubscriptionPurchaseSagaOrchestrator"/>.
