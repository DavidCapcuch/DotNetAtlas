    ...
    IDomainEventHandler<SubscriptionUpgradedDomainEvent>
{
    ...
    public async Task Handle(SubscriptionUpgradedDomainEvent domainEvent, CancellationToken ct)
    {
        ...
        _logger.LogDebug(
            ...
            "UserId: {UserId}, PreviousTier: {PreviousTier}, NewTier: {NewTier}",
            domainEvent.UserId, domainEvent.PreviousTier.Name, domainEvent.NewTier.Name);
    }
}
