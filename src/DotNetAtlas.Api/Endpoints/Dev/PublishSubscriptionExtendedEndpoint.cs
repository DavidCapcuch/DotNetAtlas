...
internal class PublishSubscriptionExtendedEndpoint : Endpoint<PublishSubscriptionExtendedCommand>
{
    ...
    {
        var avroCommand = new ExtendSubscriptionCommand
        {
        ...
        await _devEventsProducer.PublishExtendSubscriptionCommandAsync(avroCommand);

        _logger.LogInformation(
            "Published ExtendSubscriptionCommand - CorrelationId: {CorrelationId}, UserId: {UserId}, PaymentTransactionId: {PaymentTransactionId}, DurationDays: {DurationDays}",
