...
{
    public class ChangeFeedbackEndpoint : Endpoint<ChangeFeedbackCommand>
    {
        private readonly ILogger<ChangeFeedbackEndpoint> _logger;
        ...
        public ChangeFeedbackEndpoint(
            ILogger<ChangeFeedbackEndpoint> logger,
