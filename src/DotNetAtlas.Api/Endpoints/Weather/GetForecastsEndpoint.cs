...
{
    public class GetForecastsEndpoint : Endpoint<GetForecastsQuery, GetForecastsResponse>
    {
        ...
        private readonly ILogger<GetForecastsEndpoint> _logger;
        private readonly IDotNetAtlasInstrumentation _instrumentation;

        public GetForecastsEndpoint(
            ILogger<GetForecastsEndpoint> logger,
