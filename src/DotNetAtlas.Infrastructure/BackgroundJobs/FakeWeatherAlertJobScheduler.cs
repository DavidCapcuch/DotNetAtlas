...
internal sealed class FakeWeatherAlertJobScheduler : IWeatherAlertJobScheduler
{
    private readonly ILogger<FakeWeatherAlertJobScheduler> _logger;
    private readonly IRecurringJobManager _recurringJobManager;
    private readonly FakeWeatherAlertJobOptions _fakeWeatherAlertJobOptions;

    public FakeWeatherAlertJobScheduler(
        IRecurringJobManager recurringJobManager,
        IOptions<FakeWeatherAlertJobOptions> fakeWeatherAlertJobOptions,
        ILogger<FakeWeatherAlertJobScheduler> logger)
    {
    ...
    {
        var recurringJobId = FakeWeatherAlertBackgroundJob.JobId(groupName);
        _recurringJobManager.AddOrUpdate<FakeWeatherAlertBackgroundJob>(
