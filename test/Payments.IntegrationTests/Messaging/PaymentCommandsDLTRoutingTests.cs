...
/// and land on <c>payments.commands.Payments.DLT</c> within timeout — proving the partition
...
/// (or raw <c>Confluent.Kafka</c> consumer) to <c>payments.commands.Payments.DLT</c>. That
...
public sealed class PaymentCommandsDLTRoutingTests
{
    ...
    public Task PoisonCommand_AfterRetryExhaustion_LandsOnPaymentsCommandsDLT()
    {
        ...
        //
        // 4. Produce a syntactically-valid AuthorizePaymentCommand to payments.commands via
        ...
        //    raw bytes — not a typed Avro record) to payments.commands.Payments.DLT with
        //    AutoOffsetReset.Earliest and a fresh GroupId.
        //
        // 6. Within ~30s (8 retries × 5s + slack), assert:
        //      - One message on the DLT topic.
        //      - dlt-original-topic header == "payments.commands".
        ...
        //      - Original Kafka offset on payments.commands has been COMMITTED (consumer group
