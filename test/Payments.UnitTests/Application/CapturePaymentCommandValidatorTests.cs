...
public class CapturePaymentCommandValidatorTests
{
    ...
    {
        var cmd = new CapturePaymentCommand { PaymentId = Guid.CreateVersion7(), CorrelationId = Guid.CreateVersion7() };
    ...
    {
        var cmd = new CapturePaymentCommand { PaymentId = Guid.Empty, CorrelationId = Guid.CreateVersion7() };
    ...
    {
        var cmd = new CapturePaymentCommand { PaymentId = Guid.CreateVersion7(), CorrelationId = Guid.Empty };
        _validator.Validate(cmd).IsValid.Should().BeFalse();
    }
}
