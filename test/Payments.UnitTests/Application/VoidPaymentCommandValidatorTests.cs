...
public class VoidPaymentCommandValidatorTests
{
    ...
    {
        var cmd = new VoidPaymentCommand { PaymentId = Guid.CreateVersion7(), CorrelationId = Guid.CreateVersion7() };
    ...
    {
        var cmd = new VoidPaymentCommand { PaymentId = Guid.Empty, CorrelationId = Guid.CreateVersion7() };
    ...
    {
        var cmd = new VoidPaymentCommand { PaymentId = Guid.CreateVersion7(), CorrelationId = Guid.Empty };
        _validator.Validate(cmd).IsValid.Should().BeFalse();
    }
}
