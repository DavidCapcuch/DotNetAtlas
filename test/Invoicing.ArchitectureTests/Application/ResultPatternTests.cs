...
///   <item>Every <c>HandleAsync</c> returns <c>Task&lt;Result&gt;</c> or
...
public class ResultPatternTests : BaseTest
{
    ...
    public void Aggregates_Should_OnlyThrow_DataIntegrityException()
    {
        ...
        result.FailingTypes.Should().BeEmpty(
            ...
            "must be returned as Result.Fail with an Invoicing-side error factory.");
    }
    ...
    public void Handlers_ShouldNot_Throw_ArgumentOrInvalidOperationException()
    {
        ...
        result.FailingTypes.Should().BeEmpty(
            ...
            "Return Result.Fail with an Invoicing error factory instead — see error-taxonomy.md § 2.");
    }
