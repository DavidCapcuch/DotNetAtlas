...
/// assert "the right message landed in the right topic" without standing up a
/// Schema Registry container. End-to-end Avro byte-level fidelity is validated
/// in the functional tests once the host wires Schema Registry; the M6 outbox
/// test only owns "the right outbox row hits Postgres", matching the Inventory
/// + Ordering precedents.
/// </summary>
