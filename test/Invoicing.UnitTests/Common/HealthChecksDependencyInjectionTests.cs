...
{
    [Fact]
    public void AddInvoicingHealthChecks_TagsNothingForLiveness()
    {
        ...
        registrations
            ...
            .Should().BeEmpty("Invoicing has no check that a restart could fix");
    }

    [Fact]
    public void AddInvoicingHealthChecks_TagsEveryDependencyForReadiness()
    {
        var registrations = RegisterHealthChecks();
