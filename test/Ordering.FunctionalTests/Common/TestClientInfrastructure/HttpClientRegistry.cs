...
/// each carrying a forged Bearer token. Mirrors the Weather precedent
/// (<c>test/Weather.FunctionalTests/Common/TestClientInfrastructure/HttpClientRegistry.cs</c>).
/// </summary>
