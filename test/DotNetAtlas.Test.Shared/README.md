...
var sql = new SqlServerTestContainer(
    databaseName: "Weather",
    schemas: new[] { "weather", "HangFire" },
    flywayMigrationsPath: DatabasePaths.FlywayMigrationsDirectory,
    withReseed: false // optional (default: false)
);

await sql.StartAsync();

// Use for DI
builder.UseSetting("ConnectionStrings:Database", sql.ConnectionString);

// Between tests
await sql.CleanDataAsync();
