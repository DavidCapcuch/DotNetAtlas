...
public class ProductDescribedProjectionHandlerTests
{
    [Fact]
    public async Task Given_ExistingRow_Then_UpdatesDescription()
    {
        ...
        var handler = new ProductDescribedProjectionHandler(
            db, NullLogger<ProductDescribedProjectionHandler>.Instance);
