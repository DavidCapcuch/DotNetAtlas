...
/// <summary>
/// Pins how Basket's Confluent-derived Kafka options reach the Schema Registry client and the Avro
/// serializer the outbox publisher uses — the silent failure modes those types' remarks describe.
/// </summary>
/// <remarks>
...
public class KafkaOptionsTests
{
    ...
    public void AddKafkaMessaging_WhenARequiredSettingIsMissing_FailsOptionsResolution(string missingSetting)
    {
        ...
        // rather than an outbox that publishes under a vendor default.
