...
| VO | Fields | Notes |
|---|---|---|
| `Money` | shared-kernel (`Platform.SharedKernel.ValueObjects.Money`) | Signed amount + ISO 4217 currency; positive-amount (I-1) is enforced by the aggregate factory, not `Money` |
