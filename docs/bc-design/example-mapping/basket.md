...
- **R2** — Basket does NOT subscribe to Catalog's `ProductPriceChanged` and does NOT auto-refresh prices in v1 — stale prices are intentional and the frozen-pricing contract is the whole point.
