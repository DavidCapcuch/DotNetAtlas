...
DotNetAtlas is a multi-context repo. Bounded contexts live under `services/` (one folder per context). Once `/grill-with-docs` has been used, the layout looks like:
...
└── services/
    ├── Ordering/
    │   ├── CONTEXT.md
    │   └── docs/adr/                   ← Ordering-scoped decisions
    ├── Basket/
    │   ├── CONTEXT.md
    │   └── docs/adr/
    ├── Catalog/
