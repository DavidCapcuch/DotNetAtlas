...
- The v1 carry-forward `PaymentId == CorrelationId` collapse (documented in [`payments.md § 2.1.1`](../bc-design/payments.md)) — independent issue tracked under the cross-cutting wave1-followup.
