...
| 6 internal ES events named + ordered per `inventory.md § 5` | MET | All 6 at `services/Inventory/Inventory.Domain/StockItems/Events/` — `StockItemInitializedDomainEvent`, `StockReceivedDomainEvent`, `StockReservedDomainEvent`, `ReservationConfirmedDomainEvent`, `ReservationReleasedDomainEvent`, `StockAdjustedDomainEvent` |
